...
3. Start with explicit local model directories instead of auto-download:
...
Then either place them in the default cache layout above, or pass explicit directories to:
